...
priority: 2
category: memory
description: 'Comprehensive memory bank system for Cline with project registry, core file structure, and documentation workflows'
---
...
- Otherwise, default to a local, flat directory in the project's repository:
  `.ai/memory/`
  All Memory Bank markdown files live directly under `.ai/memory/`.
- Always read all Memory Bank files at the start of each task, and keep activeContext.md and progress.md updated after meaningful changes.

### Default Locations

The memory bank location is relative to the project root in one of the following paths ordered by priority:

- `.ai/memory/`
- `memory-bank/` (deprecated - use flat `.ai/memory/` instead)
...
Create additional files/folders within `.ai/context/` when they help organize:
